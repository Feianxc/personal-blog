  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        labMcgsAtlas: resolve(__dirname, 'lab-mcgs-atlas.html'),
        labProtocolStudio: resolve(__dirname, 'lab-protocol-studio.html'),
        labGeoStarEngine: resolve(__dirname, 'lab-geo-star-engine.html'),
        labDigitalBusbarChain: resolve(__dirname, 'lab-digital-busbar-chain.html'),
        labScpContainmentAdmin: resolve(__dirname, 'lab-scp-containment-admin.html'),
